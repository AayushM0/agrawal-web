...
export default function SevenPillarsGrid() {
  return (
    <section id="pillars" className="py-16 bg-white border-b border-brand-accent/20">
      <div className="max-w-7xl mx-auto px-4">
        <div className="text-center max-w-2xl mx-auto mb-12">
          ...
          <h2 className="text-2xl sm:text-3xl font-extrabold text-brand-primary">
            The 7 Pillars of the Platform
          </h2>
          <p className="text-xs sm:text-sm text-body-muted mt-2">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {pillars.map((p) => (
            <div
              key={p.number}
              className="flex flex-col bg-[#fffdfa] border border-brand-accent/30 rounded-2xl p-6 shadow-warm hover:shadow-warmLg hover:border-brand-accent transition-all relative"
            >
              <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-[#fff7dd] to-[#fae8b2] border border-brand-accent/40 flex items-center justify-center mb-4">
                {p.icon}
              </div>
              ...
              <p className="text-[11px] font-bold text-brand-gold font-devanagari mb-3">
                {p.hindi}
              </p>

              <p className="text-xs text-body-text/85 leading-relaxed mb-6 flex-1">
                {p.desc}
              </p>
