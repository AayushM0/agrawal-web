        ...
        <div className="max-w-xl mx-auto px-4 w-full text-center">
          <div className="bg-white border-2 border-brand-accent/40 rounded-3xl p-6 sm:p-12 shadow-warmLg">
            ...
            <p className="text-xs sm:text-sm text-body-text leading-relaxed mb-6">
              Thank you for registering your family in the <strong>ANTARRASHTRIYA AGARWAL SAMAJ FOUNDATION</strong>. Your submission is now in the community moderation queue. Once approved by our team, your household profile will go live.
            </p>
              ...
              <div className="p-4 rounded-xl bg-amber-50/70 border border-amber-200 mb-6">
                <label className="flex items-start gap-3 cursor-pointer">
                  ...
                  <span className="text-xs text-amber-950 leading-relaxed">
                    I confirm that I am authorized to register these details for my family in the <strong>ANTARRASHTRIYA AGARWAL SAMAJ FOUNDATION</strong>, and I agree to the community <Link href="/terms" className="underline font-bold">Terms of Service</Link> and <Link href="/privacy" className="underline font-bold">Privacy Policy</Link>.
                  </span>
                </label>
              </div>
