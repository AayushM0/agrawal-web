    ...
    <main className="py-12 bg-canvas-page">
      <div className="max-w-4xl mx-auto px-4 mb-12">
        ...
        <p className="text-base text-body-text leading-relaxed mb-6">
          The Global Agrawal Directory is an international community initiative commissioned by the Maharaja Agrasen Foundation Limited. Our goal is to create a trusted global ecosystem where Agrawals across all countries can connect, collaborate, and grow together.
        </p>
