    ...
    <main className="py-12 bg-canvas-page">
      <div className="max-w-4xl mx-auto px-4 mb-12">
        ...
        <p className="text-base text-body-text leading-relaxed mb-6">
          The ANTARRASHTRIYA AGARWAL SAMAJ FOUNDATION is an international community initiative commissioned by the Maharaja Agrasen Foundation Limited Singapore. Our goal is to create a trusted global ecosystem where Agrawals across all countries can connect, collaborate, and grow together.
        </p>
        ...
        <div className="bg-white border border-brand-accent/30 rounded-2xl p-6 shadow-warm mb-8">
          ...
          <p className="text-xs sm:text-sm text-body-text leading-relaxed">
            Community trust must always come before technology. Personal information is safeguarded with granular visibility toggles, OTP verification, and strict login gating. v1 begins with the Family Directory, laying the trusted foundation for future business, matrimonial, career, and social initiatives.
          </p>
        </div>
